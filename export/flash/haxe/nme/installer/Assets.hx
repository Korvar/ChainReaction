...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/fonts/bioliquid-regular.ttf", NME_assets_fonts_bioliquid_regular_ttf);
			resourceTypes.set ("assets/fonts/bioliquid-regular.ttf", "font");
			resourceClasses.set ("assets/fonts/bioliquid.zip", NME_assets_fonts_bioliquid_zip);
			resourceTypes.set ("assets/fonts/bioliquid.zip", "binary");
			resourceClasses.set ("assets/fonts/nasalization-rg.ttf", NME_assets_fonts_nasalization_rg_ttf);
			resourceTypes.set ("assets/fonts/nasalization-rg.ttf", "font");
			resourceClasses.set ("assets/fonts/nasalization.jpg", NME_assets_fonts_nasalization_jpg);
			resourceTypes.set ("assets/fonts/nasalization.jpg", "image");
			resourceClasses.set ("assets/fonts/nasalization.zip", NME_assets_fonts_nasalization_zip);
			resourceTypes.set ("assets/fonts/nasalization.zip", "binary");
			resourceClasses.set ("assets/fonts/read this . . . really read it.pdf", NME_assets_fonts_read_this_______really_read_it_pdf);
			resourceTypes.set ("assets/fonts/read this . . . really read it.pdf", "text");
			resourceClasses.set ("assets/fonts/read this first.html", NME_assets_fonts_read_this_first_html);
			resourceTypes.set ("assets/fonts/read this first.html", "text");
			resourceClasses.set ("assets/fonts/westminster.ttf", NME_assets_fonts_westminster_ttf);
