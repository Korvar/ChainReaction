...
class ApplicationMain {
	...
	public static function getAsset (inName:String):Dynamic {
		...
		if (inName=="assets/fonts/bioliquid-regular.ttf")
			 
			 return Assets.getFont ("assets/fonts/bioliquid-regular.ttf");
		 
		
		if (inName=="assets/fonts/bioliquid.zip")
			 
            return Assets.getBytes ("assets/fonts/bioliquid.zip");
         
		
		if (inName=="assets/fonts/nasalization-rg.ttf")
			 
			 return Assets.getFont ("assets/fonts/nasalization-rg.ttf");
		 
		
		if (inName=="assets/fonts/nasalization.jpg")
			 
            return Assets.getBitmapData ("assets/fonts/nasalization.jpg");
         
		
		if (inName=="assets/fonts/nasalization.zip")
			 
            return Assets.getBytes ("assets/fonts/nasalization.zip");
         
		
		if (inName=="assets/fonts/read this . . . really read it.pdf")
			 
			 return Assets.getText ("assets/fonts/read this . . . really read it.pdf");
         
		
		if (inName=="assets/fonts/read this first.html")
			 
			 return Assets.getText ("assets/fonts/read this first.html");
         
		
		if (inName=="assets/fonts/westminster.ttf")
			 
			 return Assets.getFont ("assets/fonts/westminster.ttf");
...
class NME_assets_fonts_bioliquid_regular_ttf extends nme.text.Font { }
class NME_assets_fonts_bioliquid_zip extends nme.utils.ByteArray { }
class NME_assets_fonts_nasalization_rg_ttf extends nme.text.Font { }
class NME_assets_fonts_nasalization_jpg extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_fonts_nasalization_zip extends nme.utils.ByteArray { }
class NME_assets_fonts_read_this_______really_read_it_pdf extends nme.utils.ByteArray { }
